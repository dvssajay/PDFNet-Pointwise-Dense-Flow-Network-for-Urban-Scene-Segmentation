...
checkpoint_dir = "./PDFNet6-2s-6/"
best_model_dir = "./PDFNet6-2s-6/"
...
#ckp_path = "./PDFNet6-2s-6/checkpoint.pt"
...
def train_val(model, params):
    ...
    #best_model_wts = copy.deepcopy(torch.load("./PDFNet6-2s-6/PDFNet6-2s-6_weights.pt"))
    ...
    for epoch in range(num_epochs):
        current_lr=get_lr(opt)
        o = open('./PDFNet6-2s-6/PDFNet6-2s-6.txt','a')
...
import os
path2models= "./PDFNet6-2s-6/PDFNet6-2s-6_"
...
o = open('./PDFNet6-2s-6/PDFNet6-2s-6-time.txt','a')
...
plt.legend()
plt.savefig('./PDFNet6-2s-6/PDFNet6-2s-6.png', dpi = 300)
...
with open('./PDFNet6-2s-6/PDFNet6-2s-6.csv', 'w') as f:
    writer = csv.writer(f)
