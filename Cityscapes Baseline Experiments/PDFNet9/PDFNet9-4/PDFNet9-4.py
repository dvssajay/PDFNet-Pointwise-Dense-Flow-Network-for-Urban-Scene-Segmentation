...
checkpoint_dir = "./PDFNet9-4/"
best_model_dir = "./PDFNet9-4/"
...
ckp_path = "./PDFNet9-4/checkpoint.pt"
...
def train_val(model, params):
    ...
    #best_model_wts = copy.deepcopy(torch.load("./PDFNet9-4/PDFNet9-4_weights.pt"))
    ...
    for epoch in range(num_epochs):
        current_lr=get_lr(opt)
        o = open('./PDFNet9-4/PDFNet9-4.txt','a')
...
import os
path2models= "./PDFNet9-4/PDFNet9-4_"
...
o = open('./PDFNet9-4/PDFNet9-4-time.txt','a')
...
plt.legend()
plt.savefig('./PDFNet9-4/PDFNet9-4.png', dpi = 300)
...
with open('./PDFNet9-4/PDFNet9-4.csv', 'w') as f:
    writer = csv.writer(f)
