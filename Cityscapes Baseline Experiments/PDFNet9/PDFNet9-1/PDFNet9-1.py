...
checkpoint_dir = "./PDFNet9-1/"
best_model_dir = "./PDFNet9-1/"
...
ckp_path = "./PDFNet9-1/checkpoint.pt"
...
def train_val(model, params):
    ...
    best_model_wts = copy.deepcopy(torch.load("./PDFNet9-1/PDFNet9-1_weights.pt"))
    ...
    #for epoch in range(num_epochs):
        current_lr=get_lr(opt)
        o = open('./PDFNet9-1/PDFNet9-1.txt','a')
...
import os
path2models= "./PDFNet9-1/PDFNet9-1_"
...
o = open('./PDFNet9-1/PDFNet9-1-time.txt','a')
...
plt.legend()
plt.savefig('./PDFNet9-1/PDFNet9-1.png', dpi = 300)
...
with open('./PDFNet9-1/PDFNet9-1.csv', 'w') as f:
    writer = csv.writer(f)
