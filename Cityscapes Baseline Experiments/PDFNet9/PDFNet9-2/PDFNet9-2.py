...
checkpoint_dir = "./PDFNet9-2/"
best_model_dir = "./PDFNet9-2/"
...
ckp_path = "./PDFNet9-2/checkpoint.pt"
...
def train_val(model, params):
    ...
    best_model_wts = copy.deepcopy(torch.load("./PDFNet9-2/PDFNet9-2_weights.pt"))
    ...
    #for epoch in range(num_epochs):
        current_lr=get_lr(opt)
        o = open('./PDFNet9-2/PDFNet9-2.txt','a')
...
import os
path2models= "./PDFNet9-2/PDFNet9-2_"
...
o = open('./PDFNet9-2/PDFNet9-2-time.txt','a')
...
plt.legend()
plt.savefig('./PDFNet9-2/PDFNet9-2.png', dpi = 300)
...
with open('./PDFNet9-2/PDFNet9-2.csv', 'w') as f:
    writer = csv.writer(f)
