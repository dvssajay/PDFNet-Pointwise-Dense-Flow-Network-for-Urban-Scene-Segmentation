...
checkpoint_dir = "./PDFNet9-6/"
best_model_dir = "./PDFNet9-6/"
...
ckp_path = "./PDFNet9-6/checkpoint.pt"
...
def train_val(model, params):
    ...
    #best_model_wts = copy.deepcopy(torch.load("./PDFNet9-6/PDFNet9-6_weights.pt"))
    ...
    for epoch in range(num_epochs):
        current_lr=get_lr(opt)
        o = open('./PDFNet9-6/PDFNet9-6.txt','a')
...
import os
path2models= "./PDFNet9-6/PDFNet9-6_"
...
o = open('./PDFNet9-6/PDFNet9-6-time.txt','a')
...
plt.legend()
plt.savefig('./PDFNet9-6/PDFNet9-6.png', dpi = 300)
...
with open('./PDFNet9-6/PDFNet9-6.csv', 'w') as f:
    writer = csv.writer(f)
