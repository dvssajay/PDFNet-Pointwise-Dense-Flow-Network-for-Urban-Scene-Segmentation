...
checkpoint_dir = "./PDFNet9-5/"
best_model_dir = "./PDFNet9-5/"
...
ckp_path = "./PDFNet9-5/checkpoint.pt"
...
def train_val(model, params):
    ...
    best_model_wts = copy.deepcopy(torch.load("./PDFNet9-5/PDFNet9-5_weights.pt"))
    ...
    #for epoch in range(num_epochs):
        current_lr=get_lr(opt)
        o = open('./PDFNet9-5/PDFNet9-5.txt','a')
...
import os
path2models= "./PDFNet9-5/PDFNet9-5_"
...
o = open('./PDFNet9-5/PDFNet9-5-time.txt','a')
...
plt.legend()
plt.savefig('./PDFNet9-5/PDFNet9-5.png', dpi = 300)
...
with open('./PDFNet9-5/PDFNet9-5.csv', 'w') as f:
    writer = csv.writer(f)
