...
o = open('./DRG08-3/DRG08-3_time.txt','w')
...
plt.legend()
plt.savefig('./DRG08-3/DRG08-3.png', dpi = 300)
...
with open('./DRG08-3/plot.csv', 'w') as f:
    writer = csv.writer(f)
