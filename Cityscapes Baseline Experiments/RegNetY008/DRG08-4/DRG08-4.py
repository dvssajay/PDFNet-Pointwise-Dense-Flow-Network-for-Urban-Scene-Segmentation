...
model = smp.DeepLabV3Plus(encoder_name='timm-regnety_008', encoder_depth=5, encoder_weights=None, encoder_output_stride=16, decoder_channels=256, decoder_atrous_rates=(12, 24, 36), in_channels=3, classes=20, activation=None, upsampling=4, aux_params=None)
...
o = open('./DRG08-4/DRG08-4_time.txt','w')
...
plt.legend()
plt.savefig('./DRG08-4/DRG08-4.png', dpi = 300)
...
with open('./DRG08-4/plot.csv', 'w') as f:
    writer = csv.writer(f)
