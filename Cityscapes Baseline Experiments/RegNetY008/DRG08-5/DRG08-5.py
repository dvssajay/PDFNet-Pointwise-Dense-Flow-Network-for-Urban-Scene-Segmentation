...
o = open('./DRG08-5/DRG08-5_time.txt','w')
...
plt.legend()
plt.savefig('./DRG08-5/DRG08-5.png', dpi = 300)
...
with open('./DRG08-5/plot.csv', 'w') as f:
    writer = csv.writer(f)
