...
checkpoint_dir = "./PDFNet12-6/"
best_model_dir = "./PDFNet12-6/"
...
ckp_path = "./PDFNet12-6/checkpoint.pt"
...
def train_val(model, params):
    ...
    best_model_wts = copy.deepcopy(torch.load("./PDFNet12-6/PDFNet12-6_weights.pt"))
    ...
    #for epoch in range(num_epochs):
        current_lr=get_lr(opt)
        o = open('./PDFNet12-6/PDFNet12-6.txt','a')
...
import os
path2models= "./PDFNet12-6/PDFNet12-6_"
...
o = open('./PDFNet12-6/PDFNet12-6-time.txt','a')
...
plt.legend()
plt.savefig('./PDFNet12-6/PDFNet12-6.png', dpi = 300)
...
with open('./PDFNet12-6/PDFNet12-6.csv', 'w') as f:
    writer = csv.writer(f)
