...
checkpoint_dir = "./PDFNet12-4/"
best_model_dir = "./PDFNet12-4/"
...
ckp_path = "./PDFNet12-4/checkpoint.pt"
...
def train_val(model, params):
    ...
    best_model_wts = copy.deepcopy(torch.load("./PDFNet12-4/PDFNet12-4_weights.pt"))
    ...
    #for epoch in range(num_epochs):
        current_lr=get_lr(opt)
        o = open('./PDFNet12-4/PDFNet12-4.txt','a')
...
import os
path2models= "./PDFNet12-4/PDFNet12-4_"
...
o = open('./PDFNet12-4/PDFNet12-4-time.txt','a')
...
plt.legend()
plt.savefig('./PDFNet12-4/PDFNet12-4.png', dpi = 300)
...
with open('./PDFNet12-4/PDFNet12-4.csv', 'w') as f:
    writer = csv.writer(f)
