...
checkpoint_dir = "./PDFNet12-3/"
best_model_dir = "./PDFNet12-3/"
...
ckp_path = "./PDFNet12-3/checkpoint.pt"
...
def train_val(model, params):
    ...
    best_model_wts = copy.deepcopy(torch.load("./PDFNet12-3/PDFNet12-3_weights.pt"))
    ...
    #for epoch in range(num_epochs):
        current_lr=get_lr(opt)
        o = open('./PDFNet12-3/PDFNet12-3.txt','a')
...
import os
path2models= "./PDFNet12-3/PDFNet12-3_"
...
o = open('./PDFNet12-3/PDFNet12-3-time.txt','a')
...
plt.legend()
plt.savefig('./PDFNet12-3/PDFNet12-3.png', dpi = 300)
...
with open('./PDFNet12-3/PDFNet12-3.csv', 'w') as f:
    writer = csv.writer(f)
