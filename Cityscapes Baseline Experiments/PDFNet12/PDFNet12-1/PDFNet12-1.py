...
checkpoint_dir = "./PDFNet12-1/"
best_model_dir = "./PDFNet12-1/"
...
ckp_path = "./PDFNet12-1/checkpoint.pt"
...
def train_val(model, params):
    ...
    best_model_wts = copy.deepcopy(torch.load("./PDFNet12-1/PDFNet12-1_weights.pt"))
    ...
    #for epoch in range(num_epochs):
        current_lr=get_lr(opt)
        o = open('./PDFNet12-1/PDFNet12-1.txt','a')
...
import os
path2models= "./PDFNet12-1/PDFNet12-1_"
...
o = open('./PDFNet12-1/PDFNet12-1-time.txt','a')
...
plt.legend()
plt.savefig('./PDFNet12-1/PDFNet12-1.png', dpi = 300)
...
with open('./PDFNet12-1/PDFNet12-1.csv', 'w') as f:
    writer = csv.writer(f)
