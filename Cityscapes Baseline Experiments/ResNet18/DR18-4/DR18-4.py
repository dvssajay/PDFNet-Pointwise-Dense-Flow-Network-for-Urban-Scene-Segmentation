...
o = open('./DR18-4/DR18-4_time.txt','w')
...
plt.legend()
plt.savefig('./DR18-4/DR18-4.png', dpi = 300)
...
with open('./DR18-4/plot.csv', 'w') as f:
    writer = csv.writer(f)
