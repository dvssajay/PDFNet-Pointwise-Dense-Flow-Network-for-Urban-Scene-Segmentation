...
o = open('./DR18-5/DR18-5_time.txt','w')
...
plt.legend()
plt.savefig('./DR18-5/DR18-5.png', dpi = 300)
...
with open('./DR18-5/plot.csv', 'w') as f:
    writer = csv.writer(f)
