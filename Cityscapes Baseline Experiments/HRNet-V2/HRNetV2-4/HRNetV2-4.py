...
checkpoint_dir = "./HRNetV2-4/"
best_model_dir = "./HRNetV2-4/"
...
ckp_path = "./HRNetV2-4/checkpoint.pt"
...
def train_val(model, params):
    ...
    best_model_wts = copy.deepcopy(torch.load("./HRNetV2-4/HRNetV2-4_weights.pt"))
    ...
    #for epoch in range(num_epochs):
        current_lr=get_lr(opt)
        o = open('./HRNetV2-4/HRNetV2-4.txt','a')
...
import os
path2models= "./HRNetV2-4/HRNetV2-4_"
...
o = open('./HRNetV2-4/HRNetV2-4-time.txt','a')
...
plt.legend()
plt.savefig('./HRNetV2-4/HRNetV2-4.png', dpi = 300)
...
with open('./HRNetV2-4/HRNetV2-4.csv', 'w') as f:
    writer = csv.writer(f)
