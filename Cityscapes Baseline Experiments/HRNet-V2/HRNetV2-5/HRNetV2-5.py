...
def hrnetv2(pretrained=False, **kwargs):
    model = HRNetV2(n_class=20, **kwargs)
    if pretrained:
...
checkpoint_dir = "./HRNetV2-5/"
best_model_dir = "./HRNetV2-5/"
...
ckp_path = "./HRNetV2-5/checkpoint.pt"
...
def train_val(model, params):
    ...
    #best_model_wts = copy.deepcopy(torch.load("./HRNetV2-5/HRNetV2-5_weights.pt"))
    ...
    for epoch in range(num_epochs):
        current_lr=get_lr(opt)
        o = open('./HRNetV2-5/HRNetV2-5.txt','a')
...
import os
path2models= "./HRNetV2-5/HRNetV2-5_"
...
o = open('./HRNetV2-5/HRNetV2-5-time.txt','a')
...
plt.legend()
plt.savefig('./HRNetV2-5/HRNetV2-5.png', dpi = 300)
...
with open('./HRNetV2-5/HRNetV2-5.csv', 'w') as f:
    writer = csv.writer(f)
