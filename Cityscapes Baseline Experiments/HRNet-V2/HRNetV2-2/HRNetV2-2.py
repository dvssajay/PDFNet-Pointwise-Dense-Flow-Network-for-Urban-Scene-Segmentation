...
checkpoint_dir = "./HRNetV2-2/"
best_model_dir = "./HRNetV2-2/"
...
ckp_path = "./HRNetV2-2/checkpoint.pt"
...
def train_val(model, params):
    ...
    best_model_wts = copy.deepcopy(torch.load("./HRNetV2-2/HRNetV2-2_weights.pt"))
    ...
    #for epoch in range(num_epochs):
        current_lr=get_lr(opt)
        o = open('./HRNetV2-2/HRNetV2-2.txt','a')
...
import os
path2models= "./HRNetV2-2/HRNetV2-2_"
...
o = open('./HRNetV2-2/HRNetV2-2-time.txt','a')
...
plt.legend()
plt.savefig('./HRNetV2-2/HRNetV2-2.png', dpi = 300)
...
with open('./HRNetV2-2/HRNetV2-2.csv', 'w') as f:
    writer = csv.writer(f)
