...
checkpoint_dir = "./HRNetV2-1/"
best_model_dir = "./HRNetV2-1/"
...
ckp_path = "./HRNetV2-1/checkpoint.pt"
...
def train_val(model, params):
    ...
    best_model_wts = copy.deepcopy(torch.load("./HRNetV2-1/HRNetV2-1_weights.pt"))
    ...
    #for epoch in range(num_epochs):
        current_lr=get_lr(opt)
        o = open('./HRNetV2-1/HRNetV2-1.txt','a')
...
import os
path2models= "./HRNetV2-1/HRNetV2-1_"
...
o = open('./HRNetV2-1/HRNetV2-1-time.txt','a')
...
plt.legend()
plt.savefig('./HRNetV2-1/HRNetV2-1.png', dpi = 300)
...
with open('./HRNetV2-1/HRNetV2-1.csv', 'w') as f:
    writer = csv.writer(f)
