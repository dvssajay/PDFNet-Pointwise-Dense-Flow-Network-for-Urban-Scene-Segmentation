...
checkpoint_dir = "./HRNetV2-3/"
best_model_dir = "./HRNetV2-3/"
...
ckp_path = "./HRNetV2-3/checkpoint.pt"
...
def train_val(model, params):
    ...
    best_model_wts = copy.deepcopy(torch.load("./HRNetV2-3/HRNetV2-3_weights.pt"))
    ...
    #for epoch in range(num_epochs):
        current_lr=get_lr(opt)
        o = open('./HRNetV2-3/HRNetV2-3.txt','a')
...
import os
path2models= "./HRNetV2-3/HRNetV2-3_"
...
o = open('./HRNetV2-3/HRNetV2-3-time.txt','a')
...
plt.legend()
plt.savefig('./HRNetV2-3/HRNetV2-3.png', dpi = 300)
...
with open('./HRNetV2-3/HRNetV2-3.csv', 'w') as f:
    writer = csv.writer(f)
