...
checkpoint_dir = "./HRNetV2-6/"
best_model_dir = "./HRNetV2-6/"
...
ckp_path = "./HRNetV2-6/checkpoint.pt"
...
def train_val(model, params):
    ...
    best_model_wts = copy.deepcopy(torch.load("./HRNetV2-6/HRNetV2-6_weights.pt"))
    ...
    #for epoch in range(num_epochs):
        current_lr=get_lr(opt)
        o = open('./HRNetV2-6/HRNetV2-6.txt','a')
...
import os
path2models= "./HRNetV2-6/HRNetV2-6_"
...
o = open('./HRNetV2-6/HRNetV2-6-time.txt','a')
...
plt.legend()
plt.savefig('./HRNetV2-6/HRNetV2-6.png', dpi = 300)
...
with open('./HRNetV2-6/HRNetV2-6.csv', 'w') as f:
    writer = csv.writer(f)
