...
checkpoint_dir = "./PDFNet3-2/"
best_model_dir = "./PDFNet3-2/"
...
ckp_path = "./PDFNet3-2/checkpoint.pt"
...
def train_val(model, params):
    ...
    best_model_wts = copy.deepcopy(torch.load("./PDFNet3-2/PDFNet3-2_weights.pt"))
    ...
    #for epoch in range(num_epochs):
        current_lr=get_lr(opt)
        o = open('./PDFNet3-2/PDFNet3-2.txt','a')
...
import os
path2models= "./PDFNet3-2/PDFNet3-2_"
...
o = open('./PDFNet3-2/PDFNet3-2-time.txt','a')
...
plt.legend()
plt.savefig('./PDFNet3-2/PDFNet3-2.png', dpi = 300)
...
with open('./PDFNet3-2/PDFNet3-2.csv', 'w') as f:
    writer = csv.writer(f)
