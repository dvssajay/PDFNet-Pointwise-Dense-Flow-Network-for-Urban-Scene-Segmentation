...
checkpoint_dir = "./PDFNet3-4/"
best_model_dir = "./PDFNet3-4/"
...
ckp_path = "./PDFNet3-4/checkpoint.pt"
...
def train_val(model, params):
    ...
    best_model_wts = copy.deepcopy(torch.load("./PDFNet3-4/PDFNet3-4_weights.pt"))
    ...
    #for epoch in range(num_epochs):
        current_lr=get_lr(opt)
        o = open('./PDFNet3-4/PDFNet3-4.txt','a')
...
import os
path2models= "./PDFNet3-4/PDFNet3-4_"
...
o = open('./PDFNet3-4/PDFNet3-4-time.txt','a')
...
plt.legend()
plt.savefig('./PDFNet3-4/PDFNet3-4.png', dpi = 300)
...
with open('./PDFNet3-4/PDFNet3-4.csv', 'w') as f:
    writer = csv.writer(f)
