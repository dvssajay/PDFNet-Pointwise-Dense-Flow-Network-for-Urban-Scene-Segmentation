...
checkpoint_dir = "./PDFNet3-3/"
best_model_dir = "./PDFNet3-3/"
...
#ckp_path = "./PDFNet3-3/checkpoint.pt"
...
def train_val(model, params):
    ...
    #best_model_wts = copy.deepcopy(torch.load("./PDFNet3-3/PDFNet3-3_weights.pt"))
    ...
    for epoch in range(num_epochs):
        current_lr=get_lr(opt)
        o = open('./PDFNet3-3/PDFNet3-3.txt','a')
...
import os
path2models= "./PDFNet3-3/PDFNet3-3_"
...
o = open('./PDFNet3-3/PDFNet3-3-time.txt','a')
...
plt.legend()
plt.savefig('./PDFNet3-3/PDFNet3-3.png', dpi = 300)
...
with open('./PDFNet3-3/PDFNet3-3.csv', 'w') as f:
    writer = csv.writer(f)
