...
checkpoint_dir = "./PDFNet3-5/"
best_model_dir = "./PDFNet3-5/"
...
ckp_path = "./PDFNet3-5/checkpoint.pt"
...
def train_val(model, params):
    ...
    best_model_wts = copy.deepcopy(torch.load("./PDFNet3-5/PDFNet3-5_weights.pt"))
    ...
    #for epoch in range(num_epochs):
        current_lr=get_lr(opt)
        o = open('./PDFNet3-5/PDFNet3-5.txt','a')
...
import os
path2models= "./PDFNet3-5/PDFNet3-5_"
...
o = open('./PDFNet3-5/PDFNet3-5-time.txt','a')
...
plt.legend()
plt.savefig('./PDFNet3-5/PDFNet3-5.png', dpi = 300)
...
with open('./PDFNet3-5/PDFNet3-5.csv', 'w') as f:
    writer = csv.writer(f)
