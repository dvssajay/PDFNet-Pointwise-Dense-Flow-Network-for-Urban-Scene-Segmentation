...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./DeeplabDenseNet161-Quarter.txt','w')
...
import os
path2models= "./DeeplabDenseNet161_Quarter"
...
o = open('./DeeplabDenseNet161_Quarter_time.txt','w')
...
torch.save(model.state_dict(), "DeeplabDenseNet161_Quarter_M")
...
plt.legend()
plt.savefig('DeeplabDenseNet161_Quarter.png', dpi = 300)
