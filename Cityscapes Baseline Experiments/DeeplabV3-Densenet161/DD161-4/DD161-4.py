...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./DD161-4/DD161-4-Trainingset.txt','w')
...
import os
path2models= "./DD161-4/DD161-4-Trainingset_"
...
o = open('./DD161-4/DD161-4_time.txt','w')
...
plt.legend()
plt.savefig('./DD161-4/DD161-4.png', dpi = 300)
...
with open('./DD161-4/plot.csv', 'w') as f:
    writer = csv.writer(f)
