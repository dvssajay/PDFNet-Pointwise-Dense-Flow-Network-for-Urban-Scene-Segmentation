...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./DD161-5/DD161-5-Trainingset.txt','w')
...
import os
path2models= "./DD161-5/DD161-5-Trainingset_"
...
o = open('./DD161-5/DD161-5_time.txt','w')
...
plt.legend()
plt.savefig('./DD161-5/DD161-5.png', dpi = 300)
...
with open('./DD161-5/plot.csv', 'w') as f:
    writer = csv.writer(f)
