...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./DD161-6/DD161-6-Trainingset.txt','w')
...
import os
path2models= "./DD161-6/DD161-6-Trainingset_"
...
o = open('./DD161-6/DD161-6_time.txt','w')
...
plt.legend()
plt.savefig('./DD161-6/DD161-6.png', dpi = 300)
...
with open('./DD161-6/plot.csv', 'w') as f:
    writer = csv.writer(f)
