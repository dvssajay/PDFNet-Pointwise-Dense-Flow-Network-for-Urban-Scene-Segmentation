...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./DeeplabDenseNet161.txt','w')
...
import os
path2models= "./DeeplabDenseNet161_"
...
o = open('./DeeplabDenseNet161_time.txt','w')
...
torch.save(model.state_dict(), "DeeplabDenseNet161_M")
...
plt.legend()
plt.savefig('DeeplabDenseNet161.png', dpi = 300)
