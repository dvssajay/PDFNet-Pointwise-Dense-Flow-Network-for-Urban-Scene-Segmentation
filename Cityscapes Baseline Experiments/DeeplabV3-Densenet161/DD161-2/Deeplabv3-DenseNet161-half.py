...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./DeeplabDenseNet161-half.txt','w')
...
import os
path2models= "./DeeplabDenseNet161_Half"
...
o = open('./DeeplabDenseNet161_Half_time.txt','w')
...
torch.save(model.state_dict(), "DeeplabDenseNet161_Half_M")
...
plt.legend()
plt.savefig('DeeplabDenseNet161_Half.png', dpi = 300)
