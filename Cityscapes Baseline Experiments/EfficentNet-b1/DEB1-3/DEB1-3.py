...
o = open('./DEB1-3/DEB1-3_time.txt','w')
...
plt.legend()
plt.savefig('./DEB1-3/DEB1-3.png', dpi = 300)
...
with open('./DEB1-3/plot.csv', 'w') as f:
    writer = csv.writer(f)
