...
model = smp.DeepLabV3Plus(encoder_name='efficientnet-b1', encoder_depth=5, encoder_weights=None, encoder_output_stride=16, decoder_channels=256, decoder_atrous_rates=(12, 24, 36), in_channels=3, classes=20, activation=None, upsampling=4, aux_params=None)
...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./DeeplabV3plus-ENb1-QuarterTrainingset.txt','w')
...
import os
path2models= "./DeeplabV3plus-ENb1-QuarterTrainingset_"
...
o = open('./DeeplabV3plus-ENb1-QuarterTrainingset_time.txt','w')
...
torch.save(model.state_dict(), "DeeplabV3plus-ENb1-QuarterTrainingset_M")
...
plt.legend()
plt.savefig('DeeplabV3plus-ENb1-QuarterTrainingset.png', dpi = 300)
