...
o = open('./DEB1-4/DEB1-4_time.txt','w')
...
plt.legend()
plt.savefig('./DEB1-4/DEB1-4.png', dpi = 300)
...
with open('./DEB1-4/plot.csv', 'w') as f:
    writer = csv.writer(f)
