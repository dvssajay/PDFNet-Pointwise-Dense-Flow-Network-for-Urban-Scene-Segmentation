...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./DeeplabV3plus-ENb1-HalfTrainingset.txt','w')
...
import os
path2models= "./DeeplabV3plus-ENb1-HalfTrainingset_"
...
o = open('./DeeplabV3plus-ENb1-HalfTrainingset_time.txt','w')
...
torch.save(model.state_dict(), "DeeplabV3plus-ENb1-HalfTrainingset_M")
...
plt.legend()
plt.savefig('DeeplabV3plus-ENb1-HalfTrainingset.png', dpi = 300)
