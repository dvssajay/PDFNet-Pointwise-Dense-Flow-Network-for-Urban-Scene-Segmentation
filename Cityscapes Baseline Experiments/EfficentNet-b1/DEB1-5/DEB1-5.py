...
o = open('./DEB1-5/DEB1-5_time.txt','w')
...
plt.legend()
plt.savefig('./DEB1-5/DEB1-5.png', dpi = 300)
...
with open('./DEB1-5/plot.csv', 'w') as f:
    writer = csv.writer(f)
