...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./DR101-6/DR101-6-Trainingset.txt','w')
...
import os
path2models= "./DR101-6/DR101-6-Trainingset_"
...
o = open('./DR101-6/DR101-6_time.txt','w')
...
plt.legend()
plt.savefig('./DR101-6/DR101-6.png', dpi = 300)
...
with open('./DR101-6/plot.csv', 'w') as f:
    writer = csv.writer(f)
