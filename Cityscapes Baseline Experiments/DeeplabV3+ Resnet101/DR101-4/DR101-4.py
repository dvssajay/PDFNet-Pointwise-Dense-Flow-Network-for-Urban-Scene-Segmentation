...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./DR101-4/DR101-4-Trainingset.txt','w')
...
import os
path2models= "./DR101-4/DR101-4-Trainingset_"
...
o = open('./DR101-4/DR101-4_time.txt','w')
...
plt.legend()
plt.savefig('./DR101-4/DR101-4.png', dpi = 300)
...
with open('./DR101-4/plot.csv', 'w') as f:
    writer = csv.writer(f)
