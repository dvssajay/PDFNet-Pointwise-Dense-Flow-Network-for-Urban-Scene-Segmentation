...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./DeeplabResnet101-FullTrainingset.txt','w')
...
import os
path2models= "./DeeplabResnet101-FullTrainingset_"
...
o = open('./DeeplabResnet101-FullTrainingset_time.txt','w')
...
torch.save(model.state_dict(), "DeeplabResnet101-FullTrainingset_M")
...
plt.legend()
plt.savefig('DeeplabResnet101-FullTrainingset.png', dpi = 300)
