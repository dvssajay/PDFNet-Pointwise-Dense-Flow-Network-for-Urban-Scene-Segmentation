...
model = DeepLabv3_plus(nInputChannels=3, n_classes=20, os=16, pretrained=True, _print=True)
...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./DeeplabResnet101-QuarterTrainingset.txt','w')
...
import os
path2models= "./DeeplabResnet101-QuarterTrainingset_"
...
o = open('./DeeplabResnet101-QuarterTrainingset_time.txt','w')
...
torch.save(model.state_dict(), "DeeplabResnet101-QuarterTrainingset_M")
...
plt.legend()
plt.savefig('DeeplabResnet101-QuarterTrainingset.png', dpi = 300)
