...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./DR101-5/DR101-5-Trainingset.txt','w')
...
import os
path2models= "./DR101-5/DR101-5-Trainingset_"
...
o = open('./DR101-5/DR101-5_time.txt','w')
...
plt.legend()
plt.savefig('./DR101-5/DR101-5.png', dpi = 300)
...
with open('./DR101-5/plot.csv', 'w') as f:
    writer = csv.writer(f)
