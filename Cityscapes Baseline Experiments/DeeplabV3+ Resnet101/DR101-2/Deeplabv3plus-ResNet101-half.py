...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./DeeplabResnet101-HalfTrainingset.txt','w')
...
import os
path2models= "./DeeplabResnet101-HalfTrainingset_"
...
o = open('./DeeplabResnet101-HalfTrainingset_time.txt','w')
...
torch.save(model.state_dict(), "DeeplabResnet101-HalfTrainingset_M")
...
plt.legend()
plt.savefig('DeeplabResnet101-HalfTrainingset.png', dpi = 300)
