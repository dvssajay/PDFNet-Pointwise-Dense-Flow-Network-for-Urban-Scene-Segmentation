...
o = open('./DMV2-3/DMV2-3_time.txt','w')
...
plt.legend()
plt.savefig('./DMV2-3/DMV2-3.png', dpi = 300)
...
with open('./DMV2-3/plot.csv', 'w') as f:
    writer = csv.writer(f)
