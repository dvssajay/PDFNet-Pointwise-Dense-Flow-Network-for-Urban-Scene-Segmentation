...
o = open('./DMV2-4/DMV2-4_time.txt','w')
...
plt.legend()
plt.savefig('./DMV2-4/DMV2-4.png', dpi = 300)
...
with open('./DMV2-4/plot.csv', 'w') as f:
    writer = csv.writer(f)
