...
o = open('./DMV2-5/DMV2-5_time.txt','w')
...
plt.legend()
plt.savefig('./DMV2-5/DMV2-5.png', dpi = 300)
...
with open('./DMV2-5/plot.csv', 'w') as f:
    writer = csv.writer(f)
