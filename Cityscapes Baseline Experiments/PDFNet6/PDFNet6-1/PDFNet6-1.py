...
checkpoint_dir = "./PDFNet6-1/"
best_model_dir = "./PDFNet6-1/"
...
ckp_path = "./PDFNet6-1/checkpoint.pt"
...
def train_val(model, params):
    ...
    best_model_wts = copy.deepcopy(torch.load("./PDFNet6-1/PDFNet6-1_weights.pt"))
    ...
    #for epoch in range(num_epochs):
        current_lr=get_lr(opt)
        o = open('./PDFNet6-1/PDFNet6-1.txt','a')
...
import os
path2models= "./PDFNet6-1/PDFNet6-1_"
...
o = open('./PDFNet6-1/PDFNet6-1-time.txt','a')
...
plt.legend()
plt.savefig('./PDFNet6-1/PDFNet6-1.png', dpi = 300)
...
with open('./PDFNet6-1/PDFNet6-1.csv', 'w') as f:
    writer = csv.writer(f)
