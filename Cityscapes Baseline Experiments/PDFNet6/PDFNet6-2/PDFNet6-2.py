...
checkpoint_dir = "./PDFNet6-2/"
best_model_dir = "./PDFNet6-2/"
...
ckp_path = "./PDFNet6-2/checkpoint.pt"
...
def train_val(model, params):
    ...
    best_model_wts = copy.deepcopy(torch.load("./PDFNet6-2/PDFNet6-2_weights.pt"))
    ...
    #for epoch in range(num_epochs):
        current_lr=get_lr(opt)
        o = open('./PDFNet6-2/PDFNet6-2.txt','a')
...
import os
path2models= "./PDFNet6-2/PDFNet6-2_"
...
o = open('./PDFNet6-2/PDFNet6-2-time.txt','a')
...
plt.legend()
plt.savefig('./PDFNet6-2/PDFNet6-2.png', dpi = 300)
...
with open('./PDFNet6-2/PDFNet6-2.csv', 'w') as f:
    writer = csv.writer(f)
