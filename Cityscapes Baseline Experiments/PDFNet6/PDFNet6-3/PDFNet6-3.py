...
checkpoint_dir = "./PDFNet6-3/"
best_model_dir = "./PDFNet6-3/"
...
#ckp_path = "./PDFNet6-3/checkpoint.pt"
...
def train_val(model, params):
    ...
    #best_model_wts = copy.deepcopy(torch.load("./PDFNet6-3/PDFNet6-3_weights.pt"))
    ...
    for epoch in range(num_epochs):
        current_lr=get_lr(opt)
        o = open('./PDFNet6-3/PDFNet6-3.txt','a')
...
import os
path2models= "./PDFNet6-3/PDFNet6-3_"
...
o = open('./PDFNet6-3/PDFNet6-3-time.txt','a')
...
plt.legend()
plt.savefig('./PDFNet6-3/PDFNet6-3.png', dpi = 300)
...
with open('./PDFNet6-3/PDFNet6-3.csv', 'w') as f:
    writer = csv.writer(f)
