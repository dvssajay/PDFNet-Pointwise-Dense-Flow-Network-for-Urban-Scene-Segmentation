...
checkpoint_dir = "./PDFNet6-5/"
best_model_dir = "./PDFNet6-5/"
...
ckp_path = "./PDFNet6-5/checkpoint.pt"
...
def train_val(model, params):
    ...
    best_model_wts = copy.deepcopy(torch.load("./PDFNet6-5/PDFNet6-5_weights.pt"))
    ...
    #for epoch in range(num_epochs):
        current_lr=get_lr(opt)
        o = open('./PDFNet6-5/PDFNet6-5.txt','a')
...
import os
path2models= "./PDFNet6-5/PDFNet6-5_"
...
o = open('./PDFNet6-5/PDFNet6-5-time.txt','a')
...
plt.legend()
plt.savefig('./PDFNet6-5/PDFNet6-5.png', dpi = 300)
...
with open('./PDFNet6-5/PDFNet6-5.csv', 'w') as f:
    writer = csv.writer(f)
