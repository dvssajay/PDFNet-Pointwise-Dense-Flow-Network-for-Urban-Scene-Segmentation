...
checkpoint_dir = "./UNet-2/"
best_model_dir = "./UNet-2/"
...
def train_val(model, params):
    ...
    best_model_wts = copy.deepcopy(torch.load("./UNet-2/UNet-2_weights.pt"))
...
o = open('./UNet-2/UNet-2-time.txt','a')
...
plt.legend()
plt.savefig('./UNet-2/UNet-2.png', dpi = 300)
...
with open('./UNet-2/UNet-2.csv', 'w') as f:
    writer = csv.writer(f)
