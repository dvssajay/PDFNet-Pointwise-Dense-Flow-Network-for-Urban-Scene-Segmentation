...
checkpoint_dir = "./UNet-5/"
best_model_dir = "./UNet-5/"
...
def train_val(model, params):
    ...
    #best_model_wts = copy.deepcopy(torch.load("./UNet-5/UNet-5_weights.pt"))
...
o = open('./UNet-5/UNet-5-time.txt','a')
...
plt.legend()
plt.savefig('./UNet-5/UNet-5.png', dpi = 300)
...
with open('./UNet-5/UNet-5.csv', 'w') as f:
    writer = csv.writer(f)
