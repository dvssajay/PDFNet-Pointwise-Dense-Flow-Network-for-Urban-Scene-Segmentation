...
checkpoint_dir = "./UNet-4/"
best_model_dir = "./UNet-4/"
...
def train_val(model, params):
    ...
    #best_model_wts = copy.deepcopy(torch.load("./UNet-4/UNet-4_weights.pt"))
...
o = open('./UNet-4/UNet-4-time.txt','a')
...
plt.legend()
plt.savefig('./UNet-4/UNet-4.png', dpi = 300)
...
with open('./UNet-4/UNet-4.csv', 'w') as f:
    writer = csv.writer(f)
