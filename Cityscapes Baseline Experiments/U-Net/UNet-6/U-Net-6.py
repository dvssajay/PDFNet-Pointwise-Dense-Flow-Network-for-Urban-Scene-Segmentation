...
checkpoint_dir = "./UNet-6/"
best_model_dir = "./UNet-6/"
...
def train_val(model, params):
    ...
    best_model_wts = copy.deepcopy(torch.load("./UNet-6/UNet-6_weights.pt"))
...
o = open('./UNet-6/UNet-6-time.txt','a')
...
plt.legend()
plt.savefig('./UNet-6/UNet-6.png', dpi = 300)
...
with open('./UNet-6/UNet-6.csv', 'w') as f:
    writer = csv.writer(f)
