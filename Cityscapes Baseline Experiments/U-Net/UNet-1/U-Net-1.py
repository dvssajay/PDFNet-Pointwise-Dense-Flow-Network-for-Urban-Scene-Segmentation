...
checkpoint_dir = "./UNet-1/"
best_model_dir = "./UNet-1/"
...
def train_val(model, params):
    ...
    best_model_wts = copy.deepcopy(torch.load("./UNet-1/UNet-1_weights.pt"))
...
o = open('./UNet-1/UNet-1-time.txt','a')
...
plt.legend()
plt.savefig('./UNet-1/UNet-1.png', dpi = 300)
...
with open('./UNet-1/UNet-1.csv', 'w') as f:
    writer = csv.writer(f)
