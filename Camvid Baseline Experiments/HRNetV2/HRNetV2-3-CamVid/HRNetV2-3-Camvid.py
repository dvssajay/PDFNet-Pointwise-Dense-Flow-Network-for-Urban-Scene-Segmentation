...
checkpoint_dir = "./HRNetV2-3-CamVid/"
best_model_dir = "./HRNetV2-3-CamVid/"
...
#ckp_path = "./HRNetV2-3-CamVid/checkpoint.pt"
...
def train_val(model, params):
    ...
    #best_model_wts = copy.deepcopy(torch.load("./HRNetV2-3-CamVid/HRNetV2-3_weights.pt"))

    #best_loss= min(loss_history["val"])
    best_loss=float('inf')
    o = open('./HRNetV2-3-CamVid/HRNetV2-3.txt','a')
...
import os
path2models= "./HRNetV2-3-CamVid/HRNetV2-3_"
...
o = open('./HRNetV2-3-CamVid/HRNetV2-3-time.txt','w')
...
plt.legend()
plt.savefig('./HRNetV2-3-CamVid/HRNetV2-3.png', dpi = 300)
...
print(iou_sum/101)
o = open('./HRNetV2-3-CamVid/HRNetV2-3_IOU_val.txt','w')
...
print(i_sum/233)
o = open('./HRNetV2-3-CamVid/HRNetV2-3_IOU_test.txt','w')
...
with open('./HRNetV2-3-CamVid/HRNetV2-3-plot.csv', 'w') as f:
    writer = csv.writer(f)
