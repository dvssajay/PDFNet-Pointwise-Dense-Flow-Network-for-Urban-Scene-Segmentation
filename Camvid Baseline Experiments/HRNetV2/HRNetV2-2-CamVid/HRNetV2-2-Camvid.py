...
checkpoint_dir = "./HRNetV2-2-CamVid/"
best_model_dir = "./HRNetV2-2-CamVid/"
...
#ckp_path = "./HRNetV2-2-CamVid/checkpoint.pt"
...
def train_val(model, params):
    ...
    #best_model_wts = copy.deepcopy(torch.load("./HRNetV2-2-CamVid/HRNetV2-2_weights.pt"))

    #best_loss= min(loss_history["val"])
    best_loss=float('inf')
    o = open('./HRNetV2-2-CamVid/HRNetV2-2.txt','a')
...
import os
path2models= "./HRNetV2-2-CamVid/HRNetV2-2_"
...
o = open('./HRNetV2-2-CamVid/HRNetV2-2-time.txt','w')
...
plt.legend()
plt.savefig('./HRNetV2-2-CamVid/HRNetV2-2.png', dpi = 300)
...
print(iou_sum/101)
o = open('./HRNetV2-2-CamVid/HRNetV2-2_IOU_val.txt','w')
...
print(i_sum/233)
o = open('./HRNetV2-2-CamVid/HRNetV2-2_IOU_test.txt','w')
...
with open('./HRNetV2-2-CamVid/HRNetV2-2-plot.csv', 'w') as f:
    writer = csv.writer(f)
