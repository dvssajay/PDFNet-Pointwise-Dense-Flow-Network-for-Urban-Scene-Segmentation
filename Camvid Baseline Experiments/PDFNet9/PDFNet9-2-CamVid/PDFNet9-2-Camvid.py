...
class PDFNet(nn.Module):
  def __init__(self):
    ...
    self.s3 = nn.Sequential(nn.Conv2d(448, 12, kernel_size=1, stride =1,bias=False),
                            nn.BatchNorm2d(12),
                            nn.ReLU(inplace=True))
    ...
    self.s4 = nn.Sequential(nn.Conv2d(736, 12, kernel_size=1, stride =1,bias=False),
                            nn.BatchNorm2d(12),
                            nn.ReLU(inplace=True))
    ...
    self.s5 = nn.Sequential(nn.Conv2d(1024, 12, kernel_size=1, stride =1,bias=False),
                            nn.BatchNorm2d(12),
                            nn.ReLU(inplace=True))
...
checkpoint_dir = "./PDFNet9-2-CamVid/"
best_model_dir = "./PDFNet9-2-CamVid/"
...
#ckp_path = "./PDFNet9-2-CamVid/checkpoint.pt"
...
def train_val(model, params):
    ...
    #best_model_wts = copy.deepcopy(torch.load("./PDFNet9-2-CamVid/PDFNet9-2_weights.pt"))

    #best_loss= min(loss_history["val"])
    best_loss=float('inf')
    o = open('./PDFNet9-2-CamVid/PDFNet9-2.txt','a')
...
import os
path2models= "./PDFNet9-2-CamVid/PDFNet9-2_"
...
o = open('./PDFNet9-2-CamVid/PDFNet9-2-time.txt','w')
...
plt.legend()
plt.savefig('./PDFNet9-2-CamVid/PDFNet9-2.png', dpi = 300)
...
print(iou_sum/101)
o = open('./PDFNet9-2-CamVid/PDFNet9-2_IOU_val.txt','w')
...
print(i_sum/233)
o = open('./PDFNet9-2-CamVid/PDFNet9-2_IOU_test.txt','w')
...
with open('./PDFNet9-2-CamVid/PDFNet9-2-plot.csv', 'w') as f:
    writer = csv.writer(f)
