...
checkpoint_dir = "./PDFNet9-3-CamVid/"
best_model_dir = "./PDFNet9-3-CamVid/"
...
#ckp_path = "./PDFNet9-3-CamVid/checkpoint.pt"
...
def train_val(model, params):
    ...
    #best_model_wts = copy.deepcopy(torch.load("./PDFNet9-3-CamVid/PDFNet9-3_weights.pt"))

    #best_loss= min(loss_history["val"])
    best_loss=float('inf')
    o = open('./PDFNet9-3-CamVid/PDFNet9-3.txt','a')
...
import os
path2models= "./PDFNet9-3-CamVid/PDFNet9-3_"
...
o = open('./PDFNet9-3-CamVid/PDFNet9-3-time.txt','w')
...
plt.legend()
plt.savefig('./PDFNet9-3-CamVid/PDFNet9-3.png', dpi = 300)
...
print(iou_sum/101)
o = open('./PDFNet9-3-CamVid/PDFNet9-3_IOU_val.txt','w')
...
print(i_sum/233)
o = open('./PDFNet9-3-CamVid/PDFNet9-3_IOU_test.txt','w')
...
with open('./PDFNet9-3-CamVid/PDFNet9-3-plot.csv', 'w') as f:
    writer = csv.writer(f)
