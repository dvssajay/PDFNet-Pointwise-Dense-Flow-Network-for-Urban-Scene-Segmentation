...
checkpoint_dir = "./UNet-2-CamVid/"
best_model_dir = "./UNet-2-CamVid/"
...
#ckp_path = "./UNet-2-CamVid/checkpoint.pt"
...
def train_val(model, params):
    ...
    #best_model_wts = copy.deepcopy(torch.load("./UNet-2-CamVid/UNet-2_weights.pt"))

    #best_loss= min(loss_history["val"])
    best_loss=float('inf')
    o = open('./UNet-2-CamVid/UNet-2.txt','a')
...
import os
path2models= "./UNet-2-CamVid/UNet-2_"
...
o = open('./UNet-2-CamVid/UNet-2-time.txt','w')
...
plt.legend()
plt.savefig('./UNet-2-CamVid/UNet-2.png', dpi = 300)
...
print(iou_sum/101)
o = open('./UNet-2-CamVid/UNet-2_IOU_val.txt','w')
...
print(i_sum/233)
o = open('./UNet-2-CamVid/UNet-2_IOU_test.txt','w')
...
with open('./UNet-2-CamVid/UNet-2-plot.csv', 'w') as f:
    writer = csv.writer(f)
