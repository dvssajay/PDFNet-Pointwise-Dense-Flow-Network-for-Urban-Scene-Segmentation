...
checkpoint_dir = "./UNet-1-CamVid/"
best_model_dir = "./UNet-1-CamVid/"
...
#ckp_path = "./UNet-1-CamVid/checkpoint.pt"
...
def train_val(model, params):
    ...
    #best_model_wts = copy.deepcopy(torch.load("./UNet-1-CamVid/UNet-1_weights.pt"))

    #best_loss= min(loss_history["val"])
    best_loss=float('inf')
    o = open('./UNet-1-CamVid/UNet-1.txt','a')
...
import os
path2models= "./UNet-1-CamVid/UNet-1_"
...
o = open('./UNet-1-CamVid/UNet-1-time.txt','w')
...
plt.legend()
plt.savefig('./UNet-1-CamVid/UNet-1.png', dpi = 300)
...
print(iou_sum/101)
o = open('./UNet-1-CamVid/UNet-1_IOU_val.txt','w')
...
print(i_sum/233)
o = open('./UNet-1-CamVid/UNet-1_IOU_test.txt','w')
...
with open('./UNet-1-CamVid/UNet-1-plot.csv', 'w') as f:
    writer = csv.writer(f)
