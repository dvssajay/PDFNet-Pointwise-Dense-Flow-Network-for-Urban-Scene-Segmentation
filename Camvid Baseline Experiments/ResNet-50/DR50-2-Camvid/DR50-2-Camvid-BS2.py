...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./DR50-2-Camvid/DR50-2-Camvid.txt','w')
...
import os
path2models= "./DR50-2-Camvid/DR50-2-Camvid_"
...
o = open('./DR50-2-Camvid/DR50-2-Camvid-time.txt','w')
...
plt.legend()
plt.savefig('./DR50-2-Camvid/DR50-2-Camvid.png', dpi = 300)
...
print(iou_sum/101)
o = open('./DR50-2-Camvid/DR50-2-Camvid_IOU_val.txt','w')
...
print(i_sum/233)
o = open('./DR50-2-Camvid/DR50-2-Camvid_IOU_test.txt','w')
...
with open('./DR50-2-Camvid/plot.csv', 'w') as f:
    writer = csv.writer(f)
