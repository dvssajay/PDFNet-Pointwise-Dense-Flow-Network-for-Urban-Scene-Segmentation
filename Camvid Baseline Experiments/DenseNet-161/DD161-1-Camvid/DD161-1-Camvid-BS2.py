...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./DD161-1-Camvid/DD161-1-Camvid.txt','w')
...
import os
path2models= "./DD161-1-Camvid/DD161-1-Camvid_"
...
o = open('./DD161-1-Camvid/DD161-1-Camvid-time.txt','w')
...
plt.legend()
plt.savefig('./DD161-1-Camvid/DD161-1-Camvid.png', dpi = 300)
...
print(iou_sum/101)
o = open('./DD161-1-Camvid/DD161-1-Camvid_IOU_val.txt','w')
...
print(i_sum/233)
o = open('./DD161-1-Camvid/DD161-1-Camvid_IOU_test.txt','w')
...
with open('./DD161-1-Camvid/plot.csv', 'w') as f:
    writer = csv.writer(f)
