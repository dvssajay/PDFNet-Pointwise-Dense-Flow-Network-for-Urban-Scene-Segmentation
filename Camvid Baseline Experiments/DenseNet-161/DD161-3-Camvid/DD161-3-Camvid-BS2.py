...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./DD161-3-Camvid/DD161-3-Camvid.txt','w')
...
import os
path2models= "./DD161-3-Camvid/DD161-3-Camvid_"
...
o = open('./DD161-3-Camvid/DD161-3-Camvid-time.txt','w')
...
plt.legend()
plt.savefig('./DD161-3-Camvid/DD161-3-Camvid.png', dpi = 300)
...
print(iou_sum/101)
o = open('./DD161-3-Camvid/DD161-3-Camvid_IOU_val.txt','w')
...
print(i_sum/233)
o = open('./DD161-3-Camvid/DD161-3-Camvid_IOU_test.txt','w')
...
with open('./DD161-3-Camvid/plot.csv', 'w') as f:
    writer = csv.writer(f)
