...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./DEB1-2-Camvid/DEB1-2-Camvid.txt','w')
...
import os
path2models= "./DEB1-2-Camvid/DEB1-2-Camvid_"
...
o = open('./DEB1-2-Camvid/DEB1-2-Camvid-time.txt','w')
...
plt.legend()
plt.savefig('./DEB1-2-Camvid/DEB1-2-Camvid.png', dpi = 300)
...
print(iou_sum/101)
o = open('./DEB1-2-Camvid/DEB1-2-Camvid_IOU_val.txt','w')
...
print(i_sum/233)
o = open('./DEB1-2-Camvid/DEB1-2-Camvid_IOU_test.txt','w')
...
with open('./DEB1-2-Camvid/plot.csv', 'w') as f:
    writer = csv.writer(f)
