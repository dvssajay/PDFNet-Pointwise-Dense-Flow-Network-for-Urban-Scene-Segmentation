...
model = smp.DeepLabV3Plus(encoder_name='timm-regnety_040', encoder_depth=5, encoder_weights=None, encoder_output_stride=16, decoder_channels=256, decoder_atrous_rates=(12, 24, 36), in_channels=3, classes=12, activation=None, upsampling=4, aux_params=None)
...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./DRG40-3-Camvid/DRG40-3-Camvid.txt','w')
...
import os
path2models= "./DRG40-3-Camvid/DRG40-3-Camvid_"
...
o = open('./DRG40-3-Camvid/DRG40-3-Camvid-time.txt','w')
...
plt.legend()
plt.savefig('./DRG40-3-Camvid/DRG40-3-Camvid.png', dpi = 300)
...
print(iou_sum/101)
o = open('./DRG40-3-Camvid/DRG40-3-Camvid_IOU_val.txt','w')
...
print(i_sum/233)
o = open('./DRG40-3-Camvid/DRG40-3-Camvid_IOU_test.txt','w')
...
with open('./DRG40-3-Camvid/plot.csv', 'w') as f:
    writer = csv.writer(f)
