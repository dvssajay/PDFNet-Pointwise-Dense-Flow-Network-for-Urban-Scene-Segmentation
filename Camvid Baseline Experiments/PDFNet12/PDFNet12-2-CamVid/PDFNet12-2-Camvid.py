...
checkpoint_dir = "./PDFNet12-2-CamVid/"
best_model_dir = "./PDFNet12-2-CamVid/"
...
#ckp_path = "./PDFNet12-2-CamVid/checkpoint.pt"
...
def train_val(model, params):
    ...
    #best_model_wts = copy.deepcopy(torch.load("./PDFNet12-2-CamVid/PDFNet12-2_weights.pt"))

    #best_loss= min(loss_history["val"])
    best_loss=float('inf')
    o = open('./PDFNet12-2-CamVid/PDFNet12-2.txt','a')
...
import os
path2models= "./PDFNet12-2-CamVid/PDFNet12-2_"
...
o = open('./PDFNet12-2-CamVid/PDFNet12-2-time.txt','w')
...
plt.legend()
plt.savefig('./PDFNet12-2-CamVid/PDFNet12-2.png', dpi = 300)
...
print(iou_sum/101)
o = open('./PDFNet12-2-CamVid/PDFNet12-2_IOU_val.txt','w')
...
print(i_sum/233)
o = open('./PDFNet12-2-CamVid/PDFNet12-2_IOU_test.txt','w')
...
with open('./PDFNet12-2-CamVid/PDFNet12-2-plot.csv', 'w') as f:
    writer = csv.writer(f)
