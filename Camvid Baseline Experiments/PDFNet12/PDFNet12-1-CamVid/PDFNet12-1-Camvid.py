...
checkpoint_dir = "./PDFNet12-1-CamVid/"
best_model_dir = "./PDFNet12-1-CamVid/"
...
#ckp_path = "./PDFNet12-1-CamVid/checkpoint.pt"
...
def train_val(model, params):
    ...
    #best_model_wts = copy.deepcopy(torch.load("./PDFNet12-1-CamVid/PDFNet12-1_weights.pt"))

    #best_loss= min(loss_history["val"])
    best_loss=float('inf')
    o = open('./PDFNet12-1-CamVid/PDFNet12-1.txt','a')
...
import os
path2models= "./PDFNet12-1-CamVid/PDFNet12-1_"
...
o = open('./PDFNet12-1-CamVid/PDFNet12-1-time.txt','w')
...
plt.legend()
plt.savefig('./PDFNet12-1-CamVid/PDFNet12-1.png', dpi = 300)
...
print(iou_sum/101)
o = open('./PDFNet12-1-CamVid/PDFNet12-1_IOU_val.txt','w')
...
print(i_sum/233)
o = open('./PDFNet12-1-CamVid/PDFNet12-1_IOU_test.txt','w')
...
with open('./PDFNet12-1-CamVid/PDFNet12-1-plot.csv', 'w') as f:
    writer = csv.writer(f)
