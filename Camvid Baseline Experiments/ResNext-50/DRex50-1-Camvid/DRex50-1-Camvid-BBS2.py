...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./DRex50-1-Camvid/DRex50-1-Camvid.txt','w')
...
import os
path2models= "./DRex50-1-Camvid/DRex50-1-Camvid_"
...
o = open('./DRex50-1-Camvid/DRex50-1-Camvid-time.txt','w')
...
plt.legend()
plt.savefig('./DRex50-1-Camvid/DRex50-1-Camvid.png', dpi = 300)
...
print(iou_sum/101)
o = open('./DRex50-1-Camvid/DRex50-1-Camvid_IOU_val.txt','w')
...
print(i_sum/233)
o = open('./DRex50-1-Camvid/DRex50-1-Camvid_IOU_test.txt','w')
...
with open('./DRex50-1-Camvid/plot.csv', 'w') as f:
    writer = csv.writer(f)
